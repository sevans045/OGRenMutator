class OG_Building_AirTower_Internals extends Rx_Building_AirTower_Internals;
...
DefaultProperties
{
	...
	FriendlyBuildingSounds(BuildingDestroyed)           = SoundNodeWave'RenX_EvaSounds.AirStrip.nod_as_destroyed'
    FriendlyBuildingSounds(BuildingUnderAttack)         = SoundNodeWave'RenX_EvaSounds.AirStrip.nod_as_under_attack'
    FriendlyBuildingSounds(BuildingRepaired)            = SoundNodeWave'RenX_EvaSounds.AirStrip.nod_as_repaired'
    FriendlyBuildingSounds(BuildingDestructionImminent) = SoundNodeWave'RenX_EvaSounds.AirStrip.nod_as_destruction_imminent'
    EnemyBuildingSounds(BuildingDestroyed)              = SoundNodeWave'RenX_EvaSounds.AirStrip.gdi_as_destroyed'
    EnemyBuildingSounds(BuildingUnderAttack)            = SoundNodeWave'RenX_EvaSounds.AirStrip.gdi_as_under_attack'
}
