class OG_FamilyInfo_GDI_Grenadier extends OG_FamilyInfo_GDI;

DefaultProperties
{
	CustomName = "Grenadier"
	FamilyID="GDI"
	Faction="GDI"
	...
	/** one1: Added. */
	InvManagerClass = class'OG_InventoryManager_GDI_Grenadier'
