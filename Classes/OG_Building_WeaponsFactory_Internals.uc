class OG_Building_WeaponsFactory_Internals extends Rx_Building_WeaponsFactory_Internals;
...
DefaultProperties
{
    ...
    FriendlyBuildingSounds(BuildingDestroyed)           = SoundNodeWave'RenX_EvaSounds.WeaponsFactory.gdi_wf_destroyed'
    FriendlyBuildingSounds(BuildingUnderAttack)         = SoundNodeWave'RenX_EvaSounds.WeaponsFactory.gdi_wf_under_attack'
    FriendlyBuildingSounds(BuildingRepaired)            = SoundNodeWave'RenX_EvaSounds.WeaponsFactory.gdi_wf_repaired'
    FriendlyBuildingSounds(BuildingDestructionImminent) = SoundNodeWave'RenX_EvaSounds.WeaponsFactory.gdi_wf_destruction_imminent'
    EnemyBuildingSounds(BuildingDestroyed)              = SoundNodeWave'RenX_EvaSounds.WeaponsFactory.nod_wf_destroyed'
    EnemyBuildingSounds(BuildingUnderAttack)            = SoundNodeWave'RenX_EvaSounds.WeaponsFactory.nod_wf_under_attack'
}