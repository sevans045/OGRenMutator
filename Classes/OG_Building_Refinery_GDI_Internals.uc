class OG_Building_Refinery_GDI_Internals extends Rx_Building_Refinery_GDI_Internals;
...
DefaultProperties
{
	...
	FriendlyBuildingSounds(BuildingDestroyed)           = SoundNodeWave'RenX_EvaSounds.Refinery_GDI.gdi_gdirefinery_destroyed'
	FriendlyBuildingSounds(BuildingUnderAttack)         = SoundNodeWave'RenX_EvaSounds.Refinery_GDI.gdi_gdirefinery_under_attack'
	FriendlyBuildingSounds(BuildingRepaired)            = SoundNodeWave'RenX_EvaSounds.Refinery_GDI.gdi_gdirefinery_repaired'
	FriendlyBuildingSounds(BuildingDestructionImminent) = SoundNodeWave'RenX_EvaSounds.Refinery_GDI.gdi_gdirefinery_destruction_imminent'
	EnemyBuildingSounds(BuildingDestroyed)              = SoundNodeWave'RenX_EvaSounds.Refinery_GDI.nod_gdirefinery_destroyed'
	EnemyBuildingSounds(BuildingUnderAttack)            = SoundNodeWave'RenX_EvaSounds.Refinery_GDI.nod_gdirefinery_under_attack'
}
