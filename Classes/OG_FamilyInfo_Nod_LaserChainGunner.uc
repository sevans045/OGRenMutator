class OG_FamilyInfo_Nod_LaserChainGunner extends OG_FamilyInfo_Nod;

DefaultProperties
{
	CustomName = "Laser Chaingunner"
	FamilyID="Nod"
	Faction="Nod"
	...
	MaxArmor               	= 250
	//Armor_Type 				= A_FLAK
	SpeedMultiplier			= 1.0//0.85 //0.8 //0.75
	...
	InvManagerClass = class'OG_InventoryManager_Nod_LaserChainGunner' 
