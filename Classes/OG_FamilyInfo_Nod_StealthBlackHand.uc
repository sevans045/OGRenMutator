class OG_FamilyInfo_Nod_StealthBlackHand extends OG_FamilyInfo_Nod;

DefaultProperties
{
	CustomName = "Stealth Black Hand"
	FamilyID="Nod"
	Faction="Nod"
	...
	SpeedMultiplier			= 1.0//1.1 // +10%, +7.5%, +5%
	Role 					= 	ROLE_Offense
	...
	InvManagerClass = class'OG_InventoryManager_Nod_StealthBlackHand' 
