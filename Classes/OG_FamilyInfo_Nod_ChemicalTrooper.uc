class OG_FamilyInfo_Nod_ChemicalTrooper extends OG_FamilyInfo_Nod;

DefaultProperties
{
	CustomName = "Chemical Trooper"
	FamilyID="Nod"
	Faction="Nod"
	...
	InvManagerClass = class'OG_InventoryManager_Nod_ChemicalTrooper' 
