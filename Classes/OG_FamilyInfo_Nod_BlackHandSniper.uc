class OG_FamilyInfo_Nod_BlackHandSniper extends OG_FamilyInfo_Nod;

DefaultProperties
{
	CustomName = "Black Hand Sniper"
	FamilyID="Nod"
	Faction="Nod"
	...
	InvManagerClass = class'OG_InventoryManager_Nod_BlackHandSniper' 
