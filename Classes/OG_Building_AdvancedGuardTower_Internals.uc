class OG_Building_AdvancedGuardTower_Internals extends Rx_Building_AdvancedGuardTower_Internals;
...
DefaultProperties
{
	...
	FriendlyBuildingSounds(BuildingDestroyed)           = SoundNodeWave'RenX_EvaSounds.AGT.gdi_agt_destroyed'
	FriendlyBuildingSounds(BuildingUnderAttack)         = SoundNodeWave'RenX_EvaSounds.AGT.gdi_agt_under_attack'
	FriendlyBuildingSounds(BuildingRepaired)            = SoundNodeWave'RenX_EvaSounds.AGT.gdi_agt_repaired'
	FriendlyBuildingSounds(BuildingDestructionImminent) = SoundNodeWave'RenX_EvaSounds.AGT.gdi_agt_destructon_imminent'
	EnemyBuildingSounds(BuildingDestroyed)              = SoundNodeWave'RenX_EvaSounds.AGT.nod_agt_destroyed'
	EnemyBuildingSounds(BuildingUnderAttack)            = SoundNodeWave'RenX_EvaSounds.AGT.nod_agt_under_attack'
}
