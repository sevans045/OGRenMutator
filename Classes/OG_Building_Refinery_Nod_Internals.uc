class OG_Building_Refinery_Nod_Internals extends Rx_Building_Refinery_Nod_Internals;
...
DefaultProperties
{
	...
	FriendlyBuildingSounds(BuildingDestroyed)           = SoundNodeWave'RenX_EvaSounds.Refinery_Nod.nod_nodrefinery_destroyed'
	FriendlyBuildingSounds(BuildingUnderAttack)         = SoundNodeWave'RenX_EvaSounds.Refinery_Nod.nod_nodrefinery_under_attack'
	FriendlyBuildingSounds(BuildingRepaired)            = SoundNodeWave'RenX_EvaSounds.Refinery_Nod.nod_nodrefinery_repaired'
	FriendlyBuildingSounds(BuildingDestructionImminent) = SoundNodeWave'RenX_EvaSounds.Refinery_Nod.nod_nodrefinery_destruction_imminent'
	EnemyBuildingSounds(BuildingDestroyed)              = SoundNodeWave'RenX_EvaSounds.Refinery_Nod.gdi_nodrefinery_destroyed'
	EnemyBuildingSounds(BuildingUnderAttack)            = SoundNodeWave'RenX_EvaSounds.Refinery_Nod.gdi_nodrefinery_under_attack'
}
