class OG_Building_PowerPlant_Nod_Internals extends Rx_Building_PowerPlant_Nod_Internals;
...
DefaultProperties
{
	...
	FriendlyBuildingSounds(BuildingDestroyed)           = SoundNodeWave'RenX_EvaSounds.PowerPlant_Nod.EVA_Nod_nodpowerplant_destroyed'
	FriendlyBuildingSounds(BuildingUnderAttack)         = SoundNodeWave'RenX_EvaSounds.PowerPlant_Nod.EVA_Nod_nodpowerplant_underattack'
	FriendlyBuildingSounds(BuildingRepaired)            = SoundNodeWave'RenX_EvaSounds.PowerPlant_Nod.EVA_Nod_nodpowerplant_repaired'
	FriendlyBuildingSounds(BuildingDestructionImminent) = SoundNodeWave'RenX_EvaSounds.PowerPlant_Nod.EVA_Nod_nodpowerplant_destruction_imminent'
	EnemyBuildingSounds(BuildingDestroyed)              = SoundNodeWave'RenX_EvaSounds.PowerPlant_Nod.EVA_GDI_nodpowerplant_destroyed'
	EnemyBuildingSounds(BuildingUnderAttack)            = SoundNodeWave'RenX_EvaSounds.PowerPlant_Nod.EVA_GDI_nodpowerplant_underattack'
}
