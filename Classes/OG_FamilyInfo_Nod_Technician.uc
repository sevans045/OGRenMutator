class OG_FamilyInfo_Nod_Technician extends OG_FamilyInfo_Nod;
...
DefaultProperties
{
	...
	MaxArmor               	= 125
	//Armor_Type 				= A_FLAK
	SpeedMultiplier			= 1.0//1.0 /*0.9 set back to 1.0 for the sake of some map design issues. Besides, they got nerfed where it hurt already. Right in the sidearm*/
	Role 					= ROLE_Defense
	/*PT Block Info*/
	/*------------*/
	bHighTier			= true
	...
	InvManagerClass = class'OG_InventoryManager_Nod_Technician' 
