class OG_Building_Barracks_Internals extends Rx_Building_Barracks_Internals;
...
DefaultProperties
{
	...
	FriendlyBuildingSounds(BuildingDestroyed)           = SoundNodeWave'RenX_BuildingSounds.Barracks.eva_gdi_destroyed_bar'
	FriendlyBuildingSounds(BuildingUnderAttack)         = SoundNodeWave'RenX_BuildingSounds.Barracks.eva_gdi_attack_bar'
	FriendlyBuildingSounds(BuildingRepaired)            = SoundNodeWave'RenX_BuildingSounds.Barracks.eva_gdi_repaired_bar'
	FriendlyBuildingSounds(BuildingDestructionImminent) = SoundNodeWave'RenX_BuildingSounds.Barracks.eva_gdi_iminent_bar'
	EnemyBuildingSounds(BuildingDestroyed)              = SoundNodeWave'RenX_BuildingSounds.Barracks.eva_nod_destroyed_bar'
	EnemyBuildingSounds(BuildingUnderAttack)            = SoundNodeWave'RenX_BuildingSounds.Barracks.eva_nod_attack_bar'
}
