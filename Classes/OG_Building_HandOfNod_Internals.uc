class OG_Building_HandOfNod_Internals extends Rx_Building_HandOfNod_Internals;
...
DefaultProperties
{
	...
	FriendlyBuildingSounds(BuildingDestroyed)           = SoundNodeWave'RenX_BuildingSounds.HON.eva_nod_destroyed_hon'
	FriendlyBuildingSounds(BuildingUnderAttack)         = SoundNodeWave'RenX_BuildingSounds.HON.eva_nod_attack_hon'
	FriendlyBuildingSounds(BuildingRepaired)            = SoundNodeWave'RenX_BuildingSounds.HON.eva_nod_repaired_hon'
	FriendlyBuildingSounds(BuildingDestructionImminent) = SoundNodeWave'RenX_BuildingSounds.HON.eva_nod_iminent_hon'
	EnemyBuildingSounds(BuildingDestroyed)              = SoundNodeWave'RenX_BuildingSounds.HON.eva_gdi_destroyed_hon'
	EnemyBuildingSounds(BuildingUnderAttack)            = SoundNodeWave'RenX_BuildingSounds.HON.eva_gdi_attack_hon'
}
