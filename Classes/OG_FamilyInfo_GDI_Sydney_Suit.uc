class OG_FamilyInfo_GDI_Sydney_Suit extends OG_FamilyInfo_GDI;
...
DefaultProperties
{
	...
	PointsForKill           = 52.5f //Gives 60 points in total. 
	MaxHealth               = 100
	MaxArmor               	= 200 //250
	//Armor_Type 				= A_FLAK
	SpeedMultiplier			= 1.0//0.95 //0.9
	...
	InvManagerClass = class'OG_InventoryManager_GDI_Sydney_Suit'
