class OG_FamilyInfo_Nod_Raveshaw_Mutant extends OG_FamilyInfo_Nod;

DefaultProperties
{
	CustomName = "Mutant Raveshaw"
	FamilyID="Nod"
	Faction="Nod"
	...
	InvManagerClass = class'OG_InventoryManager_Nod_Raveshaw_Mutant' 
